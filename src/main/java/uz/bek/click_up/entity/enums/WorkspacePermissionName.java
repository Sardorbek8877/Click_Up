package uz.bek.click_up.entity.enums;
...
public enum WorkspacePermissionName {
    ...
    CAN_ADD_OR_REMOVE_MEMBER("Add/Remove Members", "Gives user permission to add or remove to the workspace",
            Arrays.asList(WorkspaceRoleName.ROLE_OWNER, WorkspaceRoleName.ROLE_ADMIN)),
    CAN_MANAGE_STATUS("Edit statuses", "Gives permission ....",
            Arrays.asList(WorkspaceRoleName.ROLE_OWNER, WorkspaceRoleName.ROLE_ADMIN));
